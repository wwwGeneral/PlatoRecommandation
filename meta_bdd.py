meta = {
    '/ComputerScience/C/exercices/program/hello.pl':
    {
    ...
    '/ComputerScience/C/exercices/program/order_calls.pl':
    {
        'author':'Nicolas Borie',
    ...
    '/ComputerScience/C/exercices/program/call_cube.pl':
    {
        'author':'Nicolas Borie',
    ...
    '/ComputerScience/C/exercices/variable/carac_var.pl':
    {
        'author':'Nicolas Borie',
...
# while(...){
#    next_exercice(meta_bdd, s, goal={notion1:10, notion2:5}) --> suggère un bon next exo
#    (génération d'une note : random.randint(0,100) --> eleve qui fait tout avec 100/100)
#    if refus:
#        continue
#    print((exo, note))
#    update_competance(..., s, exo, note) /* Il faut que le client puisse faire un branchement */
#    print(competance(s))

# Pour charger toutes les donnés en console python3...
# >>> f = open("meta_bdd.py")
# >>> d = eval(f.read())
